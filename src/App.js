...
export default function App() {
  ...
  const [background, setBackground] = useState(
    "linear-gradient(0deg, rgba(1,82,77,1) 0%, rgba(1,82,77,1) 9%, rgba(1,82,77,1) 93%)"
  );
  ...
  const bg = useSpring({
    ...
    onRest: {
      background: () => {
        setMainScene(currentScene == 1 ? true : false);
  ...
  function SetSceneOptions(scene) {
    switch (scene) {
      ...
      case 2:
        setBackground(
          "linear-gradient(0deg, rgba(1,82,77,1) 0%, rgba(1,82,77,1) 5%, rgba(0,0,0,1) 100%)"
        );
        break;
      case 3:
        setBackground(
          "linear-gradient(0deg, rgba(39,220,190,1) 0%, rgba(39,220,209,1) 50%, rgba(39,220,209,1) 100%)"
        );
        break;
    }
  }
  ...
  console.log("MENU VISIBLE IS:", menuVisible);
      ...
      >
        ...
        <web.main style={{ ...bg }}>
          <Canvas
            ...
            invalidateFrameloop
            dpr={[1, 2]}
            camera={{ position: [0, -2, isMobile ? 4.7 : 4], fov: 40 }}
            gl={{
          ...
          <Menu style={{ display: reel ? "none" : "block" }}>
            ...
            <MenuWrap
              onClick={
                !sceneLoading
                  ? () => {
                      !reel ? setReel(true) : setReel(false);
                    }
                  : null
              }
            >
